...
func TestEncodeInstructions(t *testing.T) {
    ...
    inst3 := types.Instruction{			// BEQ [r5 + 0x200]
        ...
        Rs:     5,					// 00101
        Opcode: types.ControlOps["BEQ"],	// BEQ (Flag 0000, Mode 000)
	...
	inst4 := types.Instruction{			// BOF [r6 + 0x400]
		...
		OpType: types.Control,			// 11
		Rs:     6,					// 00110
		Opcode: types.ControlOps["BOF"],	// BOF (Flag 0100, Mode 001)
...
func TestDecodeInstructions(t *testing.T) {
	...
	tests := []struct {
		...
		{"inst3", 0x0200005D, types.Instruction{DataType: types.Integer, OpType: types.Control, Rs: 5, Opcode: types.ControlOps["BEQ"], Imm: 0x200}},
		{"inst4", 0x0400426D, types.Instruction{DataType: types.Integer, OpType: types.Control, Rs: 6, Opcode: types.ControlOps["BOF"], Imm: 0x400}},
